...
var Logo$2 = function (_a) {
    ...
    return (React.createElement("img", { src: LogoIcon }));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://pancakeswap.info/token/", target: "_blank" },
        React.createElement("img", { src: LogoIcon, width: "24px", style: { marginRight: '10px' } }),
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React.createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (
    // <NoProfileAvatar width="32px" height="32px" />
    React.createElement("img", { src: LogoIcon, width: "32px", style: { height: '32px' } }));
    if (isExternal) {
